...
class AppTheme {
  static const Color primaryColor = Color(0xFF415F91);
  static const Color secondaryColor = Color(0xFF565E71);
  static const Color errorColor = Color(0xFFBA1A1A);
  static const Color warningColor = Color(0xFFFFA000);
  static const Color successColor = Color(0xFF388E3C);

  static const Color accentBlueLight = Color(0xFF506DA0);
  static const Color accentIndigo = Color(0xFF284777);

  static const Color backgroundLight = Color(0xFFF3F3FA);
  ...
  static const Color dividerColor = Color(0xFFC4C6D0);
  static final Color shadowColor = Colors.black.withValues(alpha: 0.05);

  static const LinearGradient primaryGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFF506DA0), Color(0xFF284777)],
  );

  static final ThemeData lightTheme = const MaterialTheme(TextTheme())
      .light()
      .copyWith(
  ...
  static final ThemeData darkTheme = const MaterialTheme(TextTheme())
      .dark()
      .copyWith(
